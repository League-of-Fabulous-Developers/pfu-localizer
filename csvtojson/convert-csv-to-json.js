...
function saveJsonToFile(data, typesData, outputFolder) {
    const langData = {};
    ...
    languages.forEach(lang => {
        ...
        data.forEach(sheet => {
            ...
            sheet.data.forEach(row => {
                ...
                if (key !== undefined && translation !== undefined) { // Check for undefined values
        ...
        const finalJson = {
            ...
            TYPES: typesSection,
            FU: langData[lang]['Project FU Localization - FU'] || {}
        };
...
const inputFolder = 'csvtojson/import';
const outputFolder = 'csvtojson/export';
